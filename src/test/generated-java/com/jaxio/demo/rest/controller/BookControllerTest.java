 ...
 * Template pack-MyCelerioPack:springboot/src/test/java/rest/controller/BookControllerTest.p.vm.java
 */
...
public class BookControllerTest {
    ...
    public void testFindAll() throws Exception {
        this.mockMvc.perform(get("/api/books/")).andDo(print()).andExpect(status().isOk()).andExpect(content().string(containsString("")));
    }
    ...
    public void testFindAllByPage() throws Exception {
        ...
        this.mockMvc.perform(get("/api/books/bypage").param("page", Integer.toString(firstPage)).param("sort", "title").param("size", Integer.toString(size)))
                .andDo(print()).andExpect(status().isOk())
                // nombre d'elements en retour
                .andExpect(jsonPath(".content", hasSize(size))).andExpect(jsonPath(".numberOfElements", is(size)));
    ...
    public void testCreate() throws Exception {
        ...
        this.mockMvc
                .perform(post("/api/books/").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
                        /* add a request parameter */
                        .content(JsonUtils.convertObjectToJsonBytes(book)))
                .andDo(print()).andExpect(status().isCreated()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE));
        // FIXME: marche plus
